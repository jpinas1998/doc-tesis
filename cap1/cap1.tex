...
%el planteado por \cite{Mayi09} es el más completo, debido a que tiene en cuenta la mayor cantidad de aspectos para desarrollar la formación del equipo
...
Existen siete funciones objetivos en este modelo, a continuación se explican brevemente:
\begin{itemize}
...
%\begin{figure}[H]
%	\centering
%	\subfigure[Opciones de TEAMSOFT$^+$]{\includegraphics[width=0.2\textwidth]{figuras/opciones_team_soft.png} \label{fig:opcines_teamsoft}}
%	\subfigure[Flujo para conformar el equipo en TEAMSOFT$^+$]{\includegraphics[width=0.8\textwidth]{figuras/conformacion_equipos_asignar_jefe.png}\label{fig:conf_equip_teamsoft}}
%	\caption{TEAMSOFT$^+$}
%\end{figure}
